...
namespace cipher
{
	std::string DeffieHellman::encrypt(std::string _inputStr, int _offset) {
	...
	std::string DeffieHellman::decrypt(std::string _inputStr, int _offset) {
		return encrypt(_inputStr, -_offset);
	}

	char DeffieHellman::bound(char _charToCheck, char _left, char _right) {
